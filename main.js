...
var _user$project$Icon$svgFeatherIcon = function (className) {
...
var _user$project$Icon$delete = A2(
	_user$project$Icon$svgFeatherIcon,
	'delete',
	{
		ctor: '::',
		_0: A2(
...
var _user$project$Main$overZero = F3(
	function (n, val, fallback) {
		return (_elm_lang$core$Native_Utils.cmp(n, 0) > 0) ? val : fallback;
	});
var _user$project$Main$floatRight = function (el) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'border-radius', _1: '2.5px'},
									_1: {
										ctor: '::',
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_0: {
																				ctor: '_Tuple2',
																				_0: 'padding',
																				_1: A3(_user$project$Main$overZero, numAscents, '0.5em', '0')
																			},
																			_1: {ctor: '[]'}
																		}
																	}
...
var _user$project$Main$getLatestByGrade = F2(
	function (grade, ascents) {
		return _elm_lang$core$List$head(
			A2(
				...
				A2(
					...
					function (ascent) {
						return _elm_lang$core$Native_Utils.eq(ascent.grade, grade);
					},
					ascents)));
	});
var _user$project$Main$withoutLatest = F2(
	function (grade, ascents) {
		var maybeLatest = A2(_user$project$Main$getLatestByGrade, grade, ascents);
		return A2(
			_elm_lang$core$Maybe$withDefault,
			ascents,
			A2(
				...
				function (latest) {
					return A2(
						_elm_lang$core$List$filter,
						function (ascent) {
							return !_elm_lang$core$Native_Utils.eq(ascent, latest);
						},
						ascents);
				},
				maybeLatest));
...
var _user$project$Main$init = function (savedModel) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		A2(_elm_lang$core$Maybe$withDefault, _user$project$Main$model, savedModel),
		{ctor: '[]'});
};
var _user$project$Main$Ascent = F2(
	function (a, b) {
		return {grade: a, dateTime: b};
	});
var _user$project$Main$Del = function (a) {
	return {ctor: 'Del', _0: a};
};
var _user$project$Main$TimeStampAscent = F2(
	function (a, b) {
		return {ctor: 'TimeStampAscent', _0: a, _1: b};
	});
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							ascents: A2(_user$project$Main$withoutLatest, _p0._0, model.ascents)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$Main$updateWithStorage = F2(
	function (msg, model) {
		var _p2 = A2(_user$project$Main$update, msg, model);
		var newModel = _p2._0;
		var cmds = _p2._1;
		return {
			ctor: '_Tuple2',
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Sport Climbing Pyramid'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
										...
										_1: {
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: (_elm_lang$core$Native_Utils.cmp(numAscents, 0) > 0) ? A2(
															_rundis$elm_bootstrap$Bootstrap_Button$button,
															{
																ctor: '::',
																_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(
																	_user$project$Main$Del(grade)),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																_0: _user$project$Icon$delete,
																_1: {ctor: '[]'}
															}) : A2(
							...
							_elm_lang$core$List$reverse(
								A2(
									...
									3 + A2(
										_elm_lang$core$Basics$max,
										3,
										_user$project$Main$countDistinct(
											A2(
												_elm_lang$core$List$map,
												function (_p3) {
													return function (_) {
